...
def get_model(num_users, num_items, layers=[20, 10], reg_layers=[0, 0]):
    ...
    # Input variables
    user_input = Input(shape=(11,), name='user_input')
    item_input = Input(shape=(4,), name='item_input')
...
if __name__ == '__main__':
    dataset = "music"
    #vocabulary_lenth = 32858
    vocabulary_lenth = 50100
    with open("user_hist_music_HK", "rb") as file:
    ...
    for epoch in range(epochs):
        ...
        for uid in user_input:
            userinput.append([user_info[uid]])
