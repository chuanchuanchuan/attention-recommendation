...
def get_model(num_users, num_items, layers=[20, 10], reg_layers=[0, 0]):
    ...
    MLP_Embedding_User = Embedding(input_dim=num_users, output_dim=50, name='user_embedding',
    ...
    MLP_Embedding_Item = Embedding(input_dim=num_items, output_dim=50, name='item_embedding',
                                   embeddings_initializer=keras.initializers.RandomNormal(mean=0.0, stddev=0.05,
                                                                                          seed=None),
                                   embeddings_regularizer=l2(reg_layers[0]), input_length=1)
